...
int main()
{
    ...
    // push ex:
    // s1.push(',');
    // std::cout << "s1 pushed: " << s1.my_string << std::endl;
    ...
    // // append ex:
    // s1.append(s2);
    // std::cout << "\ns2 appended to s1: " << s1.my_string << std::endl;

    // // c_str ex:
    // std::cout << s1.c_str() << std::endl;

    // // 1 resize ex:
    // std::cout << "\ns2 capacity before: " << s2.my_capacity << std::endl;
    // s2.resize(10);
    // std::cout << "s2 capacity after: " << s2.my_capacity << std::endl;
    ...
    // // 2 resize ex:
    // s2.resize(10, '!');
    // std::cout << "\ns2 resized:" << s2.my_string << std::endl;

    // // += ex:
    // s2 += s1;
    // std::cout << "\ns2 += s1: " << s2.my_string << std::endl;
    ...
    // // + ex:
    // s3 = s1 + s2;
    // std::cout << "\ns3 = s1 + s2: " << s3.my_string 
    //           << "\nSize: " << s3.my_size 
    //           << "\nCapacity: " << s3.my_capacity << std::endl;
